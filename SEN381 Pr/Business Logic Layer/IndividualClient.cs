...
namespace SEN381_Pr
{
    ...
    public class IndividualClient : Client
    {
        ...
        public override string ClientContract { get => ClientContract; set => ClientContract = value; }
        public override string ClientAddress { get => ClientAddress; set => ClientAddress = value; }
        ...
        public override bool Equals(object obj)
        {
            return obj is IndividualClient client &&
                   ...
                   EqualityComparer<string>.Default.Equals(ClientContract, client.ClientContract) &&
                   EqualityComparer<string>.Default.Equals(ClientAddress, client.ClientAddress) &&
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = hashCode * -1521134295 + EqualityComparer<string>.Default.GetHashCode(ClientContract);
